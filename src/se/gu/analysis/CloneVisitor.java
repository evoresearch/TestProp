...
public class CloneVisitor extends ASTVisitor {
    ...
    public boolean visit(TypeDeclaration node){
        if(!node.getName().toString().equals(this.clone.getOwner())){
            ...
            //return false;
            //MUKE:this is a class with an inner class, so go ahead and look inside
            return true;
        }
        ...
        if(superType != null){
            if(superType.isSimpleType()){
                ...
                if(file != null){
                    ...
                    try {
                        CompilationUnit cu = JParser.parsePath(file.getAbsolutePath());
...
//if((clone.getX() <= start ) && (end <= clone.getY())){
    ...
    public static void main(String[] args) throws IOException{
        ...
        CompilationUnit cu = JParser.parsePath("/home/troy/SysAssure/dataset/Ant0.0/src/main/org/apache/tools/ant/types/PatternSet.java");
